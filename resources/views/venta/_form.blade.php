<form id="venta-form" method="POST" enctype="multipart/form-data">
    @csrf
    <input type="hidden" id="esNuevo" value="1">
    <input type="hidden" name="id" id="Registro_id" value="{{ old('id', $producto->id ?? '') }}">
    <input name="idcliente" id="Venta_idcliente" type="hidden" value="">
    <input name="detalle" id="Venta_detalle" type="hidden" value="">
    ...
    <div class="row ibox-content">
        ...
        <div class="form-group input-group-sm col-md-4">
            ...
            <select style="width:100%;" placeholder="" class="form-control" name="tipodoc" id="Venta_tipodoc">
        ...
        <div class="form-group input-group-sm col-md-2">
            ...
            <input size="3" maxlength="3" class="form-control allow_numero"
                   name="serie" id="Venta_serie" type="text">
        </div>
        ...
        <div class="form-group input-group-sm col-md-2">
            ...
            <input size="20" maxlength="20" class="form-control allow_numero"
                   name="numero" id="Venta_numero" type="text">
        </div>
        ...
        <div class="form-group input-group-sm col-md-8">
            ...
            <textarea style="width:100%;height:130px;"
                      ...
                      class="form-control"
                      name="observaciones"
                      id="Venta_observaciones"></textarea>
        ...
        <div class="form-group input-group-sm col-md-4">
            ...
            <div style="margin-top:20px;">
                ...
                <select style="width:100%;" placeholder="" name="idmediopago" id="Venta_idmediopago" class="form-control">
                    ...
                    $("#idtabla_clientes tbody>tr").mousedown(function(){
                        ...
                        for(var p in lista_clientes){
                            if(lista_clientes[p]["id"]==idreg){
                                $("#Venta_idcliente").val($(this).find(">td:nth-child(1)").html());
                            ...
                            if(lista_productos_search[p]["id"]==idp){
                                $("#idtabla_productos").find("tbody").append(`
                                    <tr class="itemprecform">
                                        ...
                                        <td class="form-group input-group-sm"><input style="width:100%;text-align:center;" class="form-control calcdetform allow_decimal" type="number" value="${lista_productos_search[p]["precio_venta"]}"></td>
                                        ...
                                        <td class="form-group input-group-sm">${parseFloat(lista_productos_search[p]["precio_venta"]).toFixed(2)}</td>
                                        <td>
...
function fn_calcular_totales_form(){
  ...
  var desctotal=0;
  var total=0;
  /*if($("#OrdenVenta_descuento_global_porcentaje").val().trim()!=""){
      porcdscto=$("#OrdenVenta_descuento_global_porcentaje").val();
  }
  if($("#OrdenVenta_otros_cargos").val().trim()!=""){
      otroscargos=$("#OrdenVenta_otros_cargos").val();
  }*/
    ...
    $('#Venta_total').val(parseFloat(total).toFixed(fixednumber));
}
</script>
